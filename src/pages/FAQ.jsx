...
export default function FAQ(){
  const qas = [
    ...
    {q: '¿Cómo me visto?', a: 'No hay un código de vestimenta específico, si podéis venir con camisa mejor, pero como estéis cómodos.'},
    ...
    {q: '¿Es necesario conjuntar el color de la pajarita con el de los calcetines?', a: 'Es casi imprescindible excepto si llevas pajarita de madera, en cuyo caso puedes llevar zuecos.'},
